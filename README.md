...
Основная страница, где пользователь может просмотреть имеющиеся товары на сайте. Также доступна панель фильтрации товаров, где пользователь может отобрать товары по критериям (в данном случае цена, поставщик товаров, группа товара)
